      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-blue-100">
            If you couldn&rsquo;t find the answer you were looking for, don&rsquo;t worry.
            Contact our support team for assistance with app issues, feedback,
            feature requests, or privacy-related questions.
          </p>
